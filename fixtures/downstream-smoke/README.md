...
- downstream import bundle module: `Mathlib.Logic.Iff`
- source-free proof artifact:
  `../../Mathlib/Logic/Iff/certificate.npcert`

The fixture vendors the source-free certificate import closure for
`Mathlib.Logic.Iff`:

- `vendor/npa-std/Std/Logic/Eq/certificate.npcert`
- `vendor/npa-mathlib/Mathlib/Logic/Iff/certificate.npcert`
...
The local theorems in `Downstream.LogicIff` import the Layer 3E `Logic.Iff`
closure and apply the exported theorems `iff_mp`, `or_elim`, and `false_elim`.
