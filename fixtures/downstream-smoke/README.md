...
- downstream import bundle module: `Mathlib.Algebra.Ring.Basic`
- source-free proof artifact:
  `../../Mathlib/Algebra/Ring/Basic/certificate.npcert`
...
The local theorems in `Downstream.RingBasic` import the abstract ring
foundation closure and apply the exported `RingLawArgs`, `sub_add_cancel`, and
`ring_normalize_add_mul3` surface.
