...
- downstream import bundle module: `Mathlib.Algebra.OrderedField.ScalarIdentities`
- source-free proof artifact:
  `../../Mathlib/Algebra/OrderedField/ScalarIdentities/certificate.npcert`
...
The local theorems in `Downstream.OrderedAlgebra` import the ordered algebra
and square-normalization closure and apply the exported `sqrt_sq`,
`sq_add_eq_add_sq_add_two_mul`, and
`polarization_scalar_rhs_from_ring_args` surface.
