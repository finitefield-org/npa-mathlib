...
- downstream import bundle module: `Mathlib.Analysis.Calculus.Derivative`
- source-free proof artifact:
  `../../Mathlib/Analysis/Calculus/Derivative/certificate.npcert`
...
The local theorems in `Downstream.Derivative` import the derivative closure
and apply the exported `frechet_derivative_at_intro`,
`derivative_comp_from_args`, and `partial_x_derivative_from_args` surface.
